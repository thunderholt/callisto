...
public:
	...
	//virtual float CalculateDirectIlluminationIntensityForLumel(Light* light, Vec3* lumelWorldPosition, Vec3* lumelNormal, ICollisionMesh* collisionMesh, int chunkIndex);
	virtual float CalculateDirectIlluminationIntensityForLumel(ExpandedLight* light, Vec3* lumelWorldPosition, Vec3* lumelNormal, ICollisionMesh* collisionMesh, int chunkIndex);
