...
class ProjectileActorController : public IActorController
{
public:
	ProjectileActorController();
	virtual ~ProjectileActorController();
...
class ProjectileActorControllerData : public IActorControllerData
{
public:
